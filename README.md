...
| Portal | URL contoh |
|--------|------------|
| Beranda | `http://[IP-SERVER]:4000/` → mengarah ke login pelanggan |
| Pelanggan | `http://[IP-SERVER]:4000/customer/login` (alias singkat: `/login`) |
...
2. **File Lokal di Repository**:
   File APK siap install juga tersedia di root proyek: `BillingSystem.apk` atau `public/downloads/BillingSystem.apk`.
